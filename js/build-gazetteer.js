...
const getWikidataIndonesianProvince = id => getWikidataPlace(
  id,
  ['wd:Q5098'] // province of Indonesia
)

const getWikidataAzerbaijaniDistrict = id => getWikidataPlace(
  id,
  [
...
const getWikidataBolivianDepartment = id => getWikidataPlace(
  id,
  ['wd:Q250050'] // department of Bolivia
)

const getWikidataUkrainianOblast = id => getWikidataPlace(
  id,
...
const getWikidataGeorgianRegion = id => getWikidataPlace(
  id,
...
const getWikidataMalaysianState = id => getWikidataPlace(
  id,
  ['wd:Q50464'] // state or federal territory of Malaysia
)

const getWikidataNigerienRegion = id => getWikidataPlace(
  id,
...
const getWikidataNigerianState = id => getWikidataPlace(
  id,
...
const getWikidataGuineanRegion = id => getWikidataPlace(
  id,
...
const getWikidataBurkinabeRegion = id => getWikidataPlace(
  id,
  ['wd:Q867094'] // region of Burkino Faso
)

const getWikidataBenineseDepartment = id => getWikidataPlace(
  id,
  ['wd:Q792929'] // department of Benin
)

const getWikidataJordanianGovernorate = id => getWikidataPlace(
  id,
  ['wd:Q867567'] // governorate of Jordan
)

const getWikidataKyrgyzRegion = id => getWikidataPlace(
  id,
...
const getWikidataSudaneseState = id => getWikidataPlace(
  id,
